...
import org.ui.Main;
import org.ui.swing.admin.Logging;
import org.ui.swing.admin.others.Credit;
import org.ui.swing.admin.others.Info;
import org.ui.swing.admin.others.NoQuestions;
 ...
 * @version 0.1
 */
public final class MainSwing implements ActionListener {
    // MainSwing class
    ...
    public MainSwing() {
        // Writes log
        writing.writeLog(MainSwing.class, "Start Swing based program");
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            ...
            case "UNDERSTOOD" -> {
                ...
                writing.writeLog(getClass(), " -> MainSwing.menu");
                frame2.setVisible(false);
                frame.setVisible(true);
            }
            case "I AM" -> {
                // Writes log and configures visibility and score
                writing.writeLog(getClass(), " -> MainSwing.score");
    ...
    /**
     * Method that hides MainSwing's UI
     */
    public void hideMainSwing() {
        frame.setVisible(false);
    }

    /**
     * Method that shows MainSwing's UI
     */
    public void showMainSwing() {
        frame.setVisible(true);
    }
}